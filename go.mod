...
//replace github.com/herumi/bls-go-binary => github.com/0chain/bls-go-library-zboxmobile v1.26.1
replace github.com/herumi/bls-go-binary => github.com/cnlangzi/bls-go-binary v1.26.0
