...
import (
	...
	factory "github.com/0chain/gosdk/znft/contracts/factorymoduleerc721fixed/binding"
)
...
func (s *FactoryFixed) CreateToken(owner, name, symbol, uri string, max, price, batch *big.Int, data []byte) error {
