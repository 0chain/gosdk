...
func (_Bindings *BindingsTransactor) CreateToken(opts *bind.TransactOpts, name string, symbol string, uri string, arg3 []byte) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "createToken", name, symbol, uri, arg3)
}

// CreateToken is a paid mutator transaction binding the contract method 0x136950c9.
//
// Solidity: function createToken(string name, string symbol, string uri, bytes ) returns(address)
func (_Bindings *BindingsSession) CreateToken(name string, symbol string, uri string, arg3 []byte) (*types.Transaction, error) {
	return _Bindings.Contract.CreateToken(&_Bindings.TransactOpts, name, symbol, uri, arg3)
}

// CreateToken is a paid mutator transaction binding the contract method 0x136950c9.
//
// Solidity: function createToken(string name, string symbol, string uri, bytes ) returns(address)
func (_Bindings *BindingsTransactorSession) CreateToken(name string, symbol string, uri string, arg3 []byte) (*types.Transaction, error) {
	return _Bindings.Contract.CreateToken(&_Bindings.TransactOpts, name, symbol, uri, arg3)
}
