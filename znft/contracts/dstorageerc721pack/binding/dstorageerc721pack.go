...
func (_Bindings *BindingsCaller) Closed(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "closed")
...
//
// Solidity: function closed() view returns(string)
func (_Bindings *BindingsSession) Closed() (string, error) {
	return _Bindings.Contract.Closed(&_Bindings.CallOpts)
}

// Closed is a free data retrieval call binding the contract method 0x597e1fb5.
//
// Solidity: function closed() view returns(string)
func (_Bindings *BindingsCallerSession) Closed() (string, error) {
	return _Bindings.Contract.Closed(&_Bindings.CallOpts)
}
...
func (_Bindings *BindingsCaller) Contents(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "contents", arg0)
...
//
// Solidity: function contents(uint256 ) view returns(uint256)
func (_Bindings *BindingsSession) Contents(arg0 *big.Int) (*big.Int, error) {
	return _Bindings.Contract.Contents(&_Bindings.CallOpts, arg0)
}

// Contents is a free data retrieval call binding the contract method 0xb5ecf912.
//
// Solidity: function contents(uint256 ) view returns(uint256)
func (_Bindings *BindingsCallerSession) Contents(arg0 *big.Int) (*big.Int, error) {
	return _Bindings.Contract.Contents(&_Bindings.CallOpts, arg0)
}
...
func (_Bindings *BindingsCaller) Opened(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "opened")
...
//
// Solidity: function opened() view returns(string)
func (_Bindings *BindingsSession) Opened() (string, error) {
	return _Bindings.Contract.Opened(&_Bindings.CallOpts)
}

// Opened is a free data retrieval call binding the contract method 0x5f88eade.
//
// Solidity: function opened() view returns(string)
func (_Bindings *BindingsCallerSession) Opened() (string, error) {
	return _Bindings.Contract.Opened(&_Bindings.CallOpts)
}
...
func (_Bindings *BindingsCaller) Size(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "size")
...
//
// Solidity: function size() view returns(uint256)
func (_Bindings *BindingsSession) Size() (*big.Int, error) {
	return _Bindings.Contract.Size(&_Bindings.CallOpts)
}

// Size is a free data retrieval call binding the contract method 0x949d225d.
//
// Solidity: function size() view returns(uint256)
func (_Bindings *BindingsCallerSession) Size() (*big.Int, error) {
	return _Bindings.Contract.Size(&_Bindings.CallOpts)
}
...
func (_Bindings *BindingsTransactor) Reveal(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "reveal", tokenId)
}

// Reveal is a paid mutator transaction binding the contract method 0xc2ca0ac5.
//
// Solidity: function reveal(uint256 tokenId) returns(bytes32)
func (_Bindings *BindingsSession) Reveal(tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Reveal(&_Bindings.TransactOpts, tokenId)
}

// Reveal is a paid mutator transaction binding the contract method 0xc2ca0ac5.
//
// Solidity: function reveal(uint256 tokenId) returns(bytes32)
func (_Bindings *BindingsTransactorSession) Reveal(tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Reveal(&_Bindings.TransactOpts, tokenId)
}
...
func (_Bindings *BindingsTransactor) SetClosed(opts *bind.TransactOpts, closed_ string) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "setClosed", closed_)
}

// SetClosed is a paid mutator transaction binding the contract method 0x2b079e9c.
//
// Solidity: function setClosed(string closed_) returns()
func (_Bindings *BindingsSession) SetClosed(closed_ string) (*types.Transaction, error) {
	return _Bindings.Contract.SetClosed(&_Bindings.TransactOpts, closed_)
}

// SetClosed is a paid mutator transaction binding the contract method 0x2b079e9c.
//
// Solidity: function setClosed(string closed_) returns()
func (_Bindings *BindingsTransactorSession) SetClosed(closed_ string) (*types.Transaction, error) {
	return _Bindings.Contract.SetClosed(&_Bindings.TransactOpts, closed_)
}
...
func (_Bindings *BindingsTransactor) SetOpened(opts *bind.TransactOpts, opened_ string) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "setOpened", opened_)
}

// SetOpened is a paid mutator transaction binding the contract method 0x8967032b.
//
// Solidity: function setOpened(string opened_) returns()
func (_Bindings *BindingsSession) SetOpened(opened_ string) (*types.Transaction, error) {
	return _Bindings.Contract.SetOpened(&_Bindings.TransactOpts, opened_)
}

// SetOpened is a paid mutator transaction binding the contract method 0x8967032b.
//
// Solidity: function setOpened(string opened_) returns()
func (_Bindings *BindingsTransactorSession) SetOpened(opened_ string) (*types.Transaction, error) {
	return _Bindings.Contract.SetOpened(&_Bindings.TransactOpts, opened_)
}
...
func (_Bindings *BindingsTransactor) Withdraw(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "withdraw", tokenId)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 tokenId) returns()
func (_Bindings *BindingsSession) Withdraw(tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Withdraw(&_Bindings.TransactOpts, tokenId)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 tokenId) returns()
func (_Bindings *BindingsTransactorSession) Withdraw(tokenId *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.Withdraw(&_Bindings.TransactOpts, tokenId)
}
...
func (_Bindings *BindingsTransactor) Withdraw0(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "withdraw0")
}

// Withdraw0 is a paid mutator transaction binding the contract method 0x3ccfd60b.
//
// Solidity: function withdraw() returns()
func (_Bindings *BindingsSession) Withdraw0() (*types.Transaction, error) {
	return _Bindings.Contract.Withdraw0(&_Bindings.TransactOpts)
}

// Withdraw0 is a paid mutator transaction binding the contract method 0x3ccfd60b.
//
// Solidity: function withdraw() returns()
func (_Bindings *BindingsTransactorSession) Withdraw0() (*types.Transaction, error) {
	return _Bindings.Contract.Withdraw0(&_Bindings.TransactOpts)
}
...
// BindingsClosedUpdatedIterator is returned from FilterClosedUpdated and is used to iterate over the raw logs and unpacked data for ClosedUpdated events raised by the Bindings contract.
type BindingsClosedUpdatedIterator struct {
	Event *BindingsClosedUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BindingsClosedUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BindingsClosedUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BindingsClosedUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BindingsClosedUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BindingsClosedUpdated represents a ClosedUpdated event raised by the Bindings contract.
type BindingsClosedUpdated struct {
	Previous string
	Updated  string
	Raw      types.Log // Blockchain specific contextual infos
}
...
func (_Bindings *BindingsFilterer) FilterClosedUpdated(opts *bind.FilterOpts) (*BindingsClosedUpdatedIterator, error) {

	logs, sub, err := _Bindings.contract.FilterLogs(opts, "ClosedUpdated")
	if err != nil {
		return nil, err
	}
	return &BindingsClosedUpdatedIterator{contract: _Bindings.contract, event: "ClosedUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ClosedUpdated(string previous, string updated)
func (_Bindings *BindingsFilterer) WatchClosedUpdated(opts *bind.WatchOpts, sink chan<- *BindingsClosedUpdated) (event.Subscription, error) {

	logs, sub, err := _Bindings.contract.WatchLogs(opts, "ClosedUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BindingsClosedUpdated)
				if err := _Bindings.contract.UnpackLog(event, "ClosedUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ClosedUpdated(string previous, string updated)
func (_Bindings *BindingsFilterer) ParseClosedUpdated(log types.Log) (*BindingsClosedUpdated, error) {
	event := new(BindingsClosedUpdated)
	if err := _Bindings.contract.UnpackLog(event, "ClosedUpdated", log); err != nil {
		return nil, err
	}
...
// BindingsOpenedUpdatedIterator is returned from FilterOpenedUpdated and is used to iterate over the raw logs and unpacked data for OpenedUpdated events raised by the Bindings contract.
type BindingsOpenedUpdatedIterator struct {
	Event *BindingsOpenedUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BindingsOpenedUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BindingsOpenedUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BindingsOpenedUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BindingsOpenedUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BindingsOpenedUpdated represents a OpenedUpdated event raised by the Bindings contract.
type BindingsOpenedUpdated struct {
	Previous string
	Updated  string
	Raw      types.Log // Blockchain specific contextual infos
}
...
func (_Bindings *BindingsFilterer) FilterOpenedUpdated(opts *bind.FilterOpts) (*BindingsOpenedUpdatedIterator, error) {

	logs, sub, err := _Bindings.contract.FilterLogs(opts, "OpenedUpdated")
	if err != nil {
		return nil, err
	}
	return &BindingsOpenedUpdatedIterator{contract: _Bindings.contract, event: "OpenedUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event OpenedUpdated(string previous, string updated)
func (_Bindings *BindingsFilterer) WatchOpenedUpdated(opts *bind.WatchOpts, sink chan<- *BindingsOpenedUpdated) (event.Subscription, error) {

	logs, sub, err := _Bindings.contract.WatchLogs(opts, "OpenedUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BindingsOpenedUpdated)
				if err := _Bindings.contract.UnpackLog(event, "OpenedUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OpenedUpdated(string previous, string updated)
func (_Bindings *BindingsFilterer) ParseOpenedUpdated(log types.Log) (*BindingsOpenedUpdated, error) {
	event := new(BindingsOpenedUpdated)
	if err := _Bindings.contract.UnpackLog(event, "OpenedUpdated", log); err != nil {
		return nil, err
	}
...
// BindingsPackOpenedIterator is returned from FilterPackOpened and is used to iterate over the raw logs and unpacked data for PackOpened events raised by the Bindings contract.
type BindingsPackOpenedIterator struct {
	Event *BindingsPackOpened // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BindingsPackOpenedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BindingsPackOpened)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BindingsPackOpenedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BindingsPackOpenedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BindingsPackOpened represents a PackOpened event raised by the Bindings contract.
type BindingsPackOpened struct {
	User      common.Address
	RequestId [32]byte
	TokenId   *big.Int
	Raw       types.Log // Blockchain specific contextual infos
...
func (_Bindings *BindingsFilterer) FilterPackOpened(opts *bind.FilterOpts, user []common.Address) (*BindingsPackOpenedIterator, error) {
	...
	logs, sub, err := _Bindings.contract.FilterLogs(opts, "PackOpened", userRule)
	if err != nil {
		return nil, err
	}
	return &BindingsPackOpenedIterator{contract: _Bindings.contract, event: "PackOpened", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event PackOpened(address indexed user, bytes32 requestId, uint256 tokenId)
func (_Bindings *BindingsFilterer) WatchPackOpened(opts *bind.WatchOpts, sink chan<- *BindingsPackOpened, user []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bindings.contract.WatchLogs(opts, "PackOpened", userRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BindingsPackOpened)
				if err := _Bindings.contract.UnpackLog(event, "PackOpened", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event PackOpened(address indexed user, bytes32 requestId, uint256 tokenId)
func (_Bindings *BindingsFilterer) ParsePackOpened(log types.Log) (*BindingsPackOpened, error) {
	event := new(BindingsPackOpened)
	if err := _Bindings.contract.UnpackLog(event, "PackOpened", log); err != nil {
		return nil, err
	}
...
// BindingsPackWithdrawIterator is returned from FilterPackWithdraw and is used to iterate over the raw logs and unpacked data for PackWithdraw events raised by the Bindings contract.
type BindingsPackWithdrawIterator struct {
	Event *BindingsPackWithdraw // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BindingsPackWithdrawIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BindingsPackWithdraw)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BindingsPackWithdrawIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BindingsPackWithdrawIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BindingsPackWithdraw represents a PackWithdraw event raised by the Bindings contract.
type BindingsPackWithdraw struct {
	User    common.Address
	TokenId *big.Int
	Content *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
// FilterPackWithdraw is a free log retrieval operation binding the contract event 0x3daac97a4692aded5574083ef2df0fab3d81ae477bd72a48824a4bdc5b1c87ae.
//
// Solidity: event PackWithdraw(address indexed user, uint256 tokenId, uint256 content)
func (_Bindings *BindingsFilterer) FilterPackWithdraw(opts *bind.FilterOpts, user []common.Address) (*BindingsPackWithdrawIterator, error) {
	...
	logs, sub, err := _Bindings.contract.FilterLogs(opts, "PackWithdraw", userRule)
	if err != nil {
		return nil, err
	}
	return &BindingsPackWithdrawIterator{contract: _Bindings.contract, event: "PackWithdraw", logs: logs, sub: sub}, nil
}

// WatchPackWithdraw is a free log subscription operation binding the contract event 0x3daac97a4692aded5574083ef2df0fab3d81ae477bd72a48824a4bdc5b1c87ae.
//
// Solidity: event PackWithdraw(address indexed user, uint256 tokenId, uint256 content)
func (_Bindings *BindingsFilterer) WatchPackWithdraw(opts *bind.WatchOpts, sink chan<- *BindingsPackWithdraw, user []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bindings.contract.WatchLogs(opts, "PackWithdraw", userRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BindingsPackWithdraw)
				if err := _Bindings.contract.UnpackLog(event, "PackWithdraw", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParsePackWithdraw is a log parse operation binding the contract event 0x3daac97a4692aded5574083ef2df0fab3d81ae477bd72a48824a4bdc5b1c87ae.
//
// Solidity: event PackWithdraw(address indexed user, uint256 tokenId, uint256 content)
func (_Bindings *BindingsFilterer) ParsePackWithdraw(log types.Log) (*BindingsPackWithdraw, error) {
	event := new(BindingsPackWithdraw)
	if err := _Bindings.contract.UnpackLog(event, "PackWithdraw", log); err != nil {
		return nil, err
	}
