...
func (a *Allocation) InitAllocation() error {
	...
	err := a.generateAndSetOwnerSigningPublicKey()
	if err != nil {
		return err
	}
	a.startWorker(a.ctx)
...
func (a *Allocation) generateAndSetOwnerSigningPublicKey() error {
	...
	if a.OwnerSigningPublicKey == "" && !a.Finalized && !a.Canceled {
		...
		if err != nil {
			...
			return fmt.Errorf("failed to update owner signing public key: %v", err)
		}
