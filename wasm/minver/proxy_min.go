...
func main() {
	...
	// ethwallet.go
	js.Global().Set("TokensToEth", js.FuncOf(wasm.TokensToEth))
	js.Global().Set("EthToTokens", js.FuncOf(wasm.EthToTokens))
	js.Global().Set("GTokensToEth", js.FuncOf(wasm.GTokensToEth))
	js.Global().Set("GEthToTokens", js.FuncOf(wasm.GEthToTokens))
	js.Global().Set("ConvertZcnTokenToETH", js.FuncOf(wasm.ConvertZcnTokenToETH))
	js.Global().Set("SuggestEthGasPrice", js.FuncOf(wasm.SuggestEthGasPrice))
	js.Global().Set("TransferEthTokens", js.FuncOf(wasm.TransferEthTokens))

	js.Global().Set("GetWalletAddrFromEthMnemonic", js.FuncOf(wasm.GetWalletAddrFromEthMnemonic))
	js.Global().Set("IsValidEthAddress", js.FuncOf(wasm.IsValidEthAddress))
	js.Global().Set("CreateWalletFromEthMnemonic", js.FuncOf(wasm.CreateWalletFromEthMnemonic))
