...
//
// Solidity: event FlashLoanCompleted(address indexed token, address indexed borrower, uint256 amount, uint256 feeAmount)
...
//
// Solidity: event FundsMigrated(bytes32 indexed contextId, address indexed token, address indexed provider, uint256 amount, uint256 availableAmount, uint256 originalAmount)
...
//
// Solidity: event POLWithdrawn(address indexed caller, address indexed token, uint256 polTokenAmount, uint256 userReward)
