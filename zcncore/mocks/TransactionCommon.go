...
func (_m *TransactionCommon) CancelAllocation(allocID string, fee uint64) error {
...
func (_m *TransactionCommon) CreateAllocation(car *zcncore.CreateAllocationRequest, lock uint64, fee uint64) error {
...
func (_m *TransactionCommon) CreateReadPool(fee uint64) error {
	ret := _m.Called(fee)
...
func (_m *TransactionCommon) ExecuteSmartContract(address string, methodName string, input interface{}, val uint64) (*transaction.Transaction, error) {
...
func (_m *TransactionCommon) FinalizeAllocation(allocID string, fee uint64) error {
	ret := _m.Called(allocID, fee)
...
func (_m *TransactionCommon) ReadPoolLock(allocID string, blobberID string, duration int64, lock uint64, fee uint64) error {
...
func (_m *TransactionCommon) ReadPoolUnlock(fee uint64) error {
	ret := _m.Called(fee)
...
func (_m *TransactionCommon) SetTransactionFee(txnFee uint64) error {
...
func (_m *TransactionCommon) StakePoolLock(providerId string, providerType zcncore.Provider, lock uint64, fee uint64) error {
...
func (_m *TransactionCommon) StakePoolUnlock(providerId string, providerType zcncore.Provider, fee uint64) error {
...
func (_m *TransactionCommon) UpdateAllocation(allocID string, sizeDiff int64, expirationDiff int64, lock uint64, fee uint64) error {
...
func (_m *TransactionCommon) UpdateBlobberSettings(blobber *zcncore.Blobber, fee uint64) error {
...
func (_m *TransactionCommon) UpdateValidatorSettings(validator *zcncore.Validator, fee uint64) error {
...
func (_m *TransactionCommon) WritePoolLock(allocID string, blobberID string, duration int64, lock uint64, fee uint64) error {
	ret := _m.Called(allocID, blobberID, duration, lock, fee)
...
func (_m *TransactionCommon) WritePoolUnlock(allocID string, fee uint64) error {
	ret := _m.Called(allocID, fee)
