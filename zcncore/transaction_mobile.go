...
type TransactionCommon interface {
	ExecuteSmartContracts(address, methodName string, val string, input string) error
...
func (t *Transaction) ExecuteSmartContracts(address, methodName string, val string, input string) error {
	return nil
}
