...
type TransactionCommon interface {
	ExecuteSmartContracts(address, methodName string, val string, input interface{}) error
...
func (t *Transaction) ExecuteSmartContracts(address, methodName string, val string, input interface{}) error {
	return nil
}
