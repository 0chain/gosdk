...
// 	t.Run("Test require Config", func(t *testing.T) {
// 		_config.isConfigured = false
// 		assertConfig()
// 	})
// }
...
// 					Miners:   []string{"TestInit"},
// 					Sharders: []string{"TestInit"},
// 				})
// 				require.NoError(t, err)
...
// 		_config.chain.Sharders = []string{"TestGetBalanceWallet"}
// 		_config.chain.Miners = []string{"TestGetBalanceWallet"}
// 		_config.isValidWallet = true
// 		_config.wallet.ClientID = clientID
// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "TestGetBalanceWallet/v1/client/get/balance")
// 		})).Return(&http.Response{
// 			Body: func() io.ReadCloser {
// 				jsonFR, err := json.Marshal(&Network{
// 					Miners:   []string{""},
...
// 		util.Client = &mockClient
// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "/api/v3/coins")
// 		})).Return(&http.Response{
// 			StatusCode: http.StatusOK,
...
// 		})).Return(&http.Response{
// 			StatusCode: http.StatusOK,
// 			Body:       ioutil.NopCloser(bytes.NewReader([]byte(`{"id":"mock id","market_data":{"current_price":{"usd":0.1}}}`))),
// 		}, nil).Once()

// 		resp, err := ConvertUSDToToken(1)
// 		require.NoErrorf(t, err, "unexpected error: %v", err)
// 		require.Equal(t, float64(10), resp)
// 	})
// }
...
// 	t.Run("Test_Failed", func(t *testing.T) {
// 		var mockGetBalanceCallback = mocks.GetBalanceCallback{}
// 		_config.isConfigured = false
// 		_config.isValidWallet = true
// 		_config.wallet.ClientID = clientID
...
// 		var mockGetBalanceCallback = mocks.GetBalanceCallback{}
// 		_config.isConfigured = true
// 		_config.chain.Sharders = []string{"TestGetBalance"}
// 		_config.chain.Miners = []string{"TestGetBalance"}
// 		_config.isValidWallet = true
// 		_config.wallet.ClientID = clientID

// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "TestGetBalance/v1/client/get/balance")
// 		})).Return(&http.Response{
// 			Body:       ioutil.NopCloser(bytes.NewReader([]byte(""))),
// 			StatusCode: http.StatusOK,
// 		}, nil)
...
// 		require.NoErrorf(t, err, "unexpected error: %v", err)
// 		require.Equal(t, float64(0.1), resp)
// 	})
// }
...
// 		_config.isConfigured = true
// 		_config.chain.Miners = []string{"TestGetLockedTokens"}
// 		_config.chain.Sharders = []string{"TestGetLockedTokens"}
// 		var mockGetInfoCallback = mocks.GetInfoCallback{}
// 		_config.isValidWallet = true
// 		_config.wallet.ClientID = clientID
...
// 		util.Client = &mockClient
// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "TestGetLockedTokens")
// 		})).Return(&http.Response{
// 			Body:       ioutil.NopCloser(bytes.NewReader([]byte(""))),
// 			StatusCode: http.StatusOK,
// 		}, nil)
...
// 	t.Run("Test_Success", func(t *testing.T) {
// 		_config.isConfigured = true
// 		_config.chain.Sharders = []string{"TestGetLockConfig"}
// 		_config.chain.Miners = []string{"TestGetLockConfig"}
// 		_config.isValidWallet = true
// 		_config.wallet.ClientID = clientID
// 		var mockGetInfoCallback = mocks.GetInfoCallback{}
...
// 		util.Client = &mockClient
// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "TestGetLockConfig")
// 		})).Return(&http.Response{
// 			Body:       ioutil.NopCloser(bytes.NewReader([]byte(""))),
// 			StatusCode: http.StatusOK,
// 		}, nil)
...
// 		util.Client = &mockClient
// 		mockClient.On("Do", mock.MatchedBy(func(req *http.Request) bool {
// 			return strings.HasPrefix(req.URL.Path, "authHost/setup")
// 		})).Return(&http.Response{
// 			Body:       ioutil.NopCloser(bytes.NewReader([]byte(""))),
// 			StatusCode: http.StatusOK,
// 		}, nil)
