	...
	if !(zcn.IsNull() || zcn.IsUndefined()) {
		...
		if !(sdk.IsNull() || sdk.IsUndefined()) {
			jsbridge.BindAsyncFuncs(sdk, map[string]interface{}{
				...
				"delete":                     Delete,
				"share":                      Share,
				"revokePublicShare":          RevokePublicShare,
				"removePublicShareRecipient": RemovePublicShareRecipient,
				"checkPublicShareExists":     CheckPublicShareExists,
				"getPublicShareRecipients":   GetPublicShareRecipients,
