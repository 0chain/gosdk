...
func CreateAllocation(this js.Value, p []js.Value) interface{} {
	...
	handler := js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		go func() {
			result, err := sdk.CreateAllocationWithBlobbers(datashards, parityshards, int64(size), int64(expiry), readPrice, writePrice, mcct, int64(lock), blobbers)
			if err != nil {
				reject.Invoke(map[string]interface{}{
...
func GetAllocationMinLock(this js.Value, p []js.Value) interface{} {
	...
	handler := js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		go func() {
			result, err := sdk.GetAllocationMinLockBlobbers(datashards, parityshards, int64(size), int64(expiry), readPrice, writePrice, mcct, blobbers)
			if err != nil {
				reject.Invoke(map[string]interface{}{
